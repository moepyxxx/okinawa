...
// let waveFrame: number = 0;
// // let baseStart: number = 0;
// // let baseMiddle: number = 0;
// // let baseXRange: number = 0;
// // let baseYRange: number = 0;
// // let baseEnd: number = 0;
// // let baseYEnd: number = 0;
// // let bubblePositions: {
// //   x: number;
// //   y: number;
// //   radius: number;
...
// let footPrintCoordinates: { x: number; y: number }[] = [];
// let birdCurrentX: number = 0;
// let birdCurrentY: number = 0;
// let birdTargetX: number = 0;
// let birdTargetY: number = 0;
// let isBirdRotating: boolean = false;
// let rotateTargetAngle: number = 0;
// let birdAngle: number = 0;
// let titleHeight: number = 0;
// let seaCreaturesImage: any | null = null;
// let foodImage: any | null = null;
// let natureImage: any | null = null;
// let seaImage: any | null = null;
// let glassImage: any | null = null;
// let hotelImage: any | null = null;
// let imageSettings: { image: any }[] = [];
